...
import uuid
from sqlalchemy import ARRAY, create_engine, Column, String, Boolean, Text, DateTime, ForeignKey, Table, text
...
class User(Base):
    ...
    health_goals = Column(ARRAY(String), default=['general_health'])
