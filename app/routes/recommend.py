...
#     - Uses REAL Google Maps API to find nearby places
#     - Uses REAL Gemini AI to generate motivational messages
#     - Suggests healthy alternatives based on configurable rules
#     """
...
#         radius=radius,
#         user_context=context or "",
#         include_specific_locations=include_locations  # ✅ Correct parameter name
#     )
...
#             "gemini_ai": "active"
#         }
#     }from fastapi import APIRouter, HTTPException, Queryfrom fastapi import APIRouter, HTTPException, Query
