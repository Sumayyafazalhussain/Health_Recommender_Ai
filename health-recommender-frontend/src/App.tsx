...
//             rating: rating,
//             distance: distance,
//             healthScore: getHealthScore(alt.category, rating),
...
//             <p className="tagline">Real-time health recommendations</p>
//           </div>
//         </div>
...
//           <p>AI detects unhealthy places and suggests better options</p>
...
//             </div>
//             <div className="stat-card">
//               <div className="stat-number">{usingRealData ? '✅' : '📱'}</div>
//               <div className="stat-label">{usingRealData ? 'Real Data' : 'Demo'}</div>
//             </div>
//           </div>
//         )}
...
//                 <code className="value">GET /api/api/recommend</code>
//               </div>
//             </div>
...
//           <p>Healthy Recommender AI - Real-time Recommendations</p>
//           <div className="footer-info">
//             <span>Backend: http://localhost:8000</span>
//             <span>•</span>
//             <span>Status: {backendStatus}</span>
//             <span>•</span>
//             <span>Data: {usingRealData ? 'Real' : 'Demo'}</span>
//           </div>
